...
const PROJECTS: Project[] = [
  {
    ...
    details: {
      ...
      approach: [
        "PF 구조 (금리·LTV·담보·우선수익권·책임준공) 검토",
        "인구·소득·산업단지 등 생활 SOC를 기준으로 한 입지 기반 수요조사",
        "인근 상가 계약평단가 및 분양사례를 활용한 분양가 산정 및 경쟁력 검토",
        "사업비·분양수입·수익률 기반 사업수지 및 민감도 분석",
      ],
      result: [
        "PF 130억 조달 기준 LTV 48.1%, All-in 10.2%, 필수사업비 확보율 101.6% 도출",
  ...
  },
  {
    ...
    details: {
      objective: "수원시 권선구 금곡동 금곡LG아파트를 대상으로 권리관계·입지·시세·수익성을 통합적으로 검토한 보고서입니다.",
      approach: [
  ...
  },
  {
    ...
    details: {
      objective: "서울 성수동 소재 SK V1 CENTER 1을 대상으로 건물 구조·입지·주변 상권·교통·편의시설·개발계획·매물 시세 등을 종합적으로 조사한 임장활동 보고서입니다.",
      approach: [
      "연면적·층수·주차·승강기대수 등 건물 기본 스펙 확인",
      "교통·편의시설·생활환경 기반 지역분석",
      "산업개발진흥지구 확대, 전략정비구역, 삼표부지 개발 등 주요 개발계획 검토",
      "최신 매물가격 및 과거 실거래가 비교분석",
      "현장조사 기반 상품성 평가 및 SWOT분석",
      ],
      result: [
  ...
  },
  {
    ...
    details: {
      ...
      approach: [
      "소유·운영 구조 및 점용기간 등 법적 제약요인 분석",
      "철로·동선·소음 등 물리적 문제와 상권 침체·청년 주거 수요 등 사회적 이슈 파악",
      "SM그룹·코레일·국가철도공단 등 주요 이해관계자 구조와 협의 가능성 검토",
      "청년주택 도입, 동선 개선, 재건축을 포함한 복합개발 시나리오 설계",
      ],
      result: [
      "장기 공실·체납·안전 문제로 기존 구조의 정상 운영 가능성 매우 낮음",
      "법적·물리적 조건을 종합할 때 국가귀속 후 무상철거가 가장 타당",
      "철로 상부 보행데크 설치는 현실적 한계가 커 기존 육교 및 회전교차로를 활용한 대학–상권–역사 연결동선 개선이 적합",
      "저층 상가 활성화+상층부 청년주거+지상 보행 동선 확보를 중심으로 최종 개발안 도출",
      ],
      role: [
  ...
  },
  {
    ...
    details: {
      ...
      approach: [
      "1~7년 보유 후 매각 현금흐름을 연도별로 정리해 DCF 분석",
      "현 임대조건 기반 Cap Rate·매각가·IRR 산정",
      "월세/관리비/보증금 조정 및 렌트프리/TI 반영한 4가지 개선 시나리오 설정",
      "시나리오별 NOI·IRR 변동 비교를 통해 수익성 개선 가능성 검토",
      ],
      result: [
      "기존 IRR 약 6.84%로, 기대수익률 대비 매입 매력도 낮음",
      "4가지 개선안 중 IRR이 상승한 것은 option 2(관리비 3,000원 인상 및 월세 인상률 완화)뿐이며, 상승 폭도 약 0.09%p로 매우 제한적",
      "부분매입하는 구조로 부가수익 창출 및 운영 효율성 개선 여지 작음",
      "입지 자체의 안정성은 인정되나, 매입가 재조정 없이는 투자적정성 부족 판단",
      ],
      role: [
  ...
  },
  {
    ...
    details: {
      ...
      "국내 공공주택 공급 현황과 토지임대주택 제도 실패 요인 파악",
      "서울 국공유지 분포, 지가, PIR 등을 기준으로 적용 가능 지역 검토",
      "적합 행정구를 선정 후, 지역별 공급·정착 방안 제안",
      ],
      result: [
      "싱가포르는 넓은 국유지와 CPF 활용 덕에 공공주택 공급이 안정적으로 운영",
      "한국은 토지임대료 부담, 소유 중심 인식, 공급량 부족 등으로 제도 정착이 어려움",
      "서울 국공유지는 대부분 이미 활용 중이거나 주택 입지로 부적합한 경우가 많음",
      "지가 안정화 관점으로는 중구·종로구·서초구가 비교적 적용 가능성이 있는 지역으로 파악됨",
      ],
      role: [
