...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"/uploads/project-0-1763031851249.png","video":"","title":"평택시 동삭동 라움프라자 신축사업 PF Information Memorandum","description":"신규 상업시설 개발을 위한 PF 구조 설계, 사업성 분석, 리스크 요인 검토 및 투자자용 IM 제작","pdf":"/Pyeongtaek_IM.pdf"},{"image":"/Geumgok_AuctionReport-thumb.png","video":"","title":"금곡엘지아파트 경매 권리분석보고서","description":"말소기준권리·선순위·후순위 권리관계 분석 및 배당가능액/낙찰가 계산에 기반한 실무형 분석 보고서","pdf":"/Geumgok_AuctionReport.pdf"},{"image":"/Seongsu_SiteVisitReport-thumb.png","video":"","title":"성수동 SKV1센터 1 임장활동보고서","description":"입지·접근성·주변 상권 및 개발계획을 조사하고, 건물 물리적 특성·임대현황·수요·위험요인을 분석한 현장 기반 자산진단 보고서","pdf":"/Seongsu_SiteVisitReport.pdf"},{"image":"/Shinchon_SitePlanning-thumb.png","video":"","title":"신촌 민자역사 공실 문제 해결을 위한 청년주택 및 주거단지 계획 연구","description":"철거 후 청년주택·생활지원시설을 도입하는 주거복합 및 역세권 활성화 개발안 수립","pdf":"/Shinchon_SitePlanning.pdf"},{"image":"/Gwanggyo_AssetManagement-thumb.png","video":"","title":"광교 원희캐슬 B동 수익성 개선안","description":"저수익 구간의 임대구조 재진단 후 리모델링·임대전략·MD 구성 재편을 통한 NOI 개선 전략","pdf":"/Gwanggyo_AssetManagement.pdf"},{"image":"/Singapore_LandLeaseHousing-thumb.png","video":"","title":"싱가포르 토지임대부주택 제도 정착방안","description":"싱가포르 토지임대부 구조·공급체계·가격 메커니즘을 분석하고 국내 정착 방안 제안","pdf":"/Singapore_LandLeaseHousing.pdf"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
